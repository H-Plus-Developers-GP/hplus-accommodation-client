...
export const GET = async () => {
    try {
        connectDB();
        const advertisement = await AdvertisementModel.find().populate([
                ...
                populate: [
                    ...
                    },
                    {
                        ...
                        populate: [
                            ...
                            { path: "funishingType", select: "label", model: FunishingTypeModel },
                        ],
                    },
                    { path: "otherInfo", select: "label", model: PropertyTypeModel },
                ],
            },
            { path: "contactInfo", select: "username email phone contactInfo", model: UserModel },
        ]);
